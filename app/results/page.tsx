    ...
    <div className="screen-enter" style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
          ...
          <span style={{
            fontSize: 10, color: 'rgba(37,211,102,0.75)',
            fontWeight: 600, whiteSpace: 'nowrap', letterSpacing: '0.01em',
          }}>
            פוסט חדש כל שבוע — חינם לגמרי
          </span>
        </div>
      </div>
      ...
      {imageFullscreen && sharedImageUrl && (
        <div
        ...
        >
          ...
          >
            <Image
              ...
              width={1200}
              height={1200}
              style={{ objectFit: 'contain', maxWidth: '90vw', maxHeight: '90vh', display: 'block' }}
              unoptimized
            />
          </div>
        </div>
