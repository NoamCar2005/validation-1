...
הגדרת שדות הפלט:
- "content" = גוף הפוסט המלא (3-4 פסקאות, 100+ מילים) — זהו הטקסט הארוך שמתפרסם ברשת החברתית
- "copy" = כותרת/הוק קצר בלבד (1-2 משפטים קצרים) — זהו השורה שמופיעה מעל הפוסט, לא גוף הפוסט
